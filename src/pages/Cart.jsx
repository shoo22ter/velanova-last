    ...
    <div className="container section-padding" style={{ paddingTop: '120px', minHeight: '80vh' }}>
      ...
      <div className="grid" style={{ gridTemplateColumns: '2fr 1fr', gap: '40px' }}>
        <div className="cart-items">
          {cart.map(item => (
            <div key={item.id} className="cart-item" style={{ display: 'flex', gap: '20px', borderBottom: '1px solid var(--color-border)', paddingBottom: '20px', marginBottom: '20px' }}>
        ...
        <div className="cart-summary" style={{ backgroundColor: 'var(--color-light-gray)', padding: '30px', height: 'fit-content' }}>
