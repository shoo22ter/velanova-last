...
const Checkout = () => {
  ...
  if (cart.length === 0) {
    return <div className="container section-padding text-center" style={{ paddingTop: '150px', minHeight: '60vh' }}><h2>Your cart is empty</h2><Link to="/shop" className="btn btn-primary mt-4">Return to Shop</Link></div>;
  }
  ...
  return (
    <div className="container section-padding" style={{ paddingTop: '120px', minHeight: '80vh' }}>
      ...
      <div className="grid" style={{ gridTemplateColumns: '1.5fr 1fr', gap: '50px' }}>
        ...
        <div className="order-summary" style={{ backgroundColor: 'var(--color-light-gray)', padding: '30px', height: 'fit-content' }}>
